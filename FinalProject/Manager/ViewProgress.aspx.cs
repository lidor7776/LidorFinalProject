...
public partial class Manager_ViewProgress : System.Web.UI.Page
{
    ...
    protected void ShowStudent(object sender, EventArgs e)
    {
        ...
        {
            Label27.Text = "";
            string studentMail = mail.Text;
            DataSet correctAnswers = DAL.GetDataSet("SELECT exId FROM dbo.Progress WHERE email = '" + studentMail + "' AND isCorrect = '" + true + "'");
        ...
        {
            Label27.Text = "תלמיד לא קיים במערכת";
