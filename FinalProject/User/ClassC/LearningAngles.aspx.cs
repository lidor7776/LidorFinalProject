...
using System.Media;
public partial class User_ClassC_LearningAngles : System.Web.UI.Page
{
    SoundPlayer paraA;
    SoundPlayer paraB;
    SoundPlayer paraC;
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        paraA = new SoundPlayer(Server.MapPath("~/Audio/C/AnglesParaA.wav"));
        paraB = new SoundPlayer(Server.MapPath("~/Audio/C/AnglesParaB.wav"));
        paraC = new SoundPlayer(Server.MapPath("~/Audio/C/AnglesParaC.wav"));
    }
    /* Play And Pause Para */
