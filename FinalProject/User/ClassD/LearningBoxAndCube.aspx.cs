...
using System.Media;
public partial class User_ClassD_LearningBoxAndCube : System.Web.UI.Page
{
    SoundPlayer paraA;
    SoundPlayer paraB;
    SoundPlayer paraC;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        paraD = new SoundPlayer(Server.MapPath("~/Audio/D/BoxAndCubeParaD.wav"));
        paraE = new SoundPlayer(Server.MapPath("~/Audio/D/BoxAndCubeParaE.wav"));
        paraF = new SoundPlayer(Server.MapPath("~/Audio/D/BoxAndCubeParaF.wav"));
        paraG = new SoundPlayer(Server.MapPath("~/Audio/D/BoxAndCubeParaF.wav"));
    }
    /* Play And Pause Para */
    ...
    protected void PlayParaF(object sender, EventArgs e)
    {
        paraF.Play();
    }
    protected void StopParaF(object sender, EventArgs e)
    {
        paraF.Stop();
    }
    protected void PlayParaG(object sender, EventArgs e)
    {
        paraG.Play();
    }
    protected void StopParaG(object sender, EventArgs e)
    {
        paraG.Stop();
    }
    /* Open And Close Para */
    ...
    protected void CloseSeventhP(object sender, EventArgs e)
    {
        seventhP.Style.Add("display", "none");
    }
    protected void OpenSeventhP(object sender, EventArgs e)
    {
        seventhP.Style.Add("display", "block");
    }
}